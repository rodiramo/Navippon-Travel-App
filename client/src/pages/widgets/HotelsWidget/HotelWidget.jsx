...
const HotelWidget = ({
  ...
  const handleEdit = () => navigate(`/edit-hotel/${hotelId}`);
  ...
  const handleDeleteHotel = async () => {
    if (onDelete) {
      await onDelete();
      setSnackbarMessage("¡Hotel eliminado exitosamente!");
  ...
  const handleViewDetails = () => navigate(`/hotels/${hotelId}`);
  ...
  return (
    ...
    >
      ...
      <div className="activity-details">
        <Typography variant="h4" color="primary" className="hotel-title">
          {name}{" "}
      ...
      <Dialog open={openDeleteModal} onClose={handleCloseDeleteModal}>
        ...
        <DialogContent>
          <Typography>
            ¿Está seguro de que desea eliminar este hotel? Esta acción no se
            puede deshacer.
          </Typography>
        </DialogContent>
