            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 mt-3 text-center md:text-left">
                ...
                <div className="text-center md:text-left">
                    ...
                    <div className="flex justify-center md:justify-start space-x-4 mb-2">
                        <a href="#"><FaInstagram className="text-2xl md:text-4xl" /></a>
                        <a href="#"><SlSocialFacebook className="text-2xl md:text-3xl" /></a>
                        <a href="#"><FaXTwitter className="text-2xl md:text-3xl" /></a>
                    </div>
                    <div className="flex justify-center md:justify-start space-x-4">
                        <a href="#"><TbBrandTiktok className="text-2xl md:text-3xl" /></a>
                        <a href="#"><SlSocialYoutube className="text-2xl md:text-3xl" /></a>
                        <a href="#"><PiTelegramLogo className="text-2xl md:text-3xl" /></a>
                    </div>
                </div>
            </div>
        </div>
